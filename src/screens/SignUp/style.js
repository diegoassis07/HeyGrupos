...
export const ContentInputName = styled.View`
  ...
  padding: 10px;
`;
export const ContentInputEmail = styled(ContentInputName)`
  /* Estendendo os estilos do ContentInputName */
`;
...
export const ContentInputPassword = styled(ContentInputName)`
  /* Estendendo os estilos do ContentInputName */
`;
